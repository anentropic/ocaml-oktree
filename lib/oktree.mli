(** OKtree is a simple octree implementation in OCaml, intended to efficiently
    find the nearest match for an arbitrary point among a set of target points
...
v}
    ...
    The original use case for this library was finding nearest match in a
    palette of RGB colours.
    ...
    OKtree defines a [VEC3] module type for the points. This is deliberately
    compatible with the [Gg] library's {{:https://erratique.ch/software/gg/doc/Gg/index.html#module-V3}Gg.V3}
    module type.
...
*)
    ...
    - [Okt.of_list] builds a tree from list of points; [~leaf_size] controls
      max points per leaf before splitting (optional, default: [16]).
